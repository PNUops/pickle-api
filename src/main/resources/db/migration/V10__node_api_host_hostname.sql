...
-- (M3) the client must address the API by a SAN name. LXC 101 maps pve1 to
-- 172.30.0.1 in /etc/hosts (provisioned by infra/scripts/create-app-lxc.sh).
-- Found at the M3 cutover smoke (2026-07-09): step 3 failed hostname
